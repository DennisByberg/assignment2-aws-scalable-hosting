...
(remove_docker_stack) & spinner $!

print_info "Scaling down Auto Scaling Group..."
(scale_down_asg) & spinner $!

print_info "Cleaning up S3 bucket..."
(cleanup_s3_bucket) & spinner $!

print_info "Destroying infrastructure..."
(destroy_infrastructure) & spinner $!

print_info "Cleaning up ECR repository..."
(cleanup_ecr) & spinner $!

print_info "Removing SSH keys..."
(cleanup_ssh_keys) & spinner $!
