...
# Get AWS Account ID and set IMAGE_URI
...
print_info "Getting AWS account info..."
get_aws_account_info

print_info "Waiting for Docker Swarm to initialize..."
(wait_for_swarm_init) & spinner $!

print_info "Ensuring ECR repository exists..."
(ensure_ecr_repository) & spinner $!
